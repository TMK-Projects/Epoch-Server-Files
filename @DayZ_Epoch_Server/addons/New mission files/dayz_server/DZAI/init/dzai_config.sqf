...
DZAI_dynAreaBlacklist = [BlacklistStarySobor","BlacklistKlemTrader","BlacklistNWAFTrader","BlacklistHeroTrader","BlacklistBanditTrader"];
...
DZAI_gradeChances0 = [0.00,0.80,0.10,0.00,0.10];	
...
DZAI_gradeChances1 = [0.00,0.60,0.30,0.05,0.05];	
...
DZAI_gradeChances3 = [0.00,0.50,0.10,0.20,0.20];	
...
DZAI_skill0 = [	
	["aimingAccuracy",0.12,0.185],
	["aimingShake",0.45,0.55],
	["aimingSpeed",0.45,0.55],
	["endurance",0.40,0.50],
	["spotDistance",0.25,0.35],
	["spotTime",0.35,0.45],
	["courage",0.40,0.70],
