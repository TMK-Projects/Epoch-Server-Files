...
_spawnCrate addBackpackCargoGlobal ["DZ_British_ACU", 2];
_spawnCrate addBackpackCargoGlobal ["DZ_GunBag_EP1", 2];
_spawnCrate addBackpackCargoGlobal ["DZ_LargeGunBag_EP1", 2];
